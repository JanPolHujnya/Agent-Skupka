...
# тексты = ровно список «Где продано» (Продажи!W2:W9), Q-валидация сверяет
# байт-в-байт; латиница/лишний символ = красный уголок «вне диапазона»
PLACES = [
    ("avito", "Авито"),
    ("vk", "VK"),
    ("tg", "Телеграм"),
...
# тексты ровно как в листе «Правила» (A5:A10): по ним L ищет % через MATCH,
# лишний/недостающий символ = «проценты не выставились» (в т.ч. пробел в full)
ROLES = [
    ...
    ("both", "И товар, и клиент. Данил — только деньги", None),
]
