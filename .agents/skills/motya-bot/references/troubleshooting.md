...
- Роль Матвея на листе Продажи: K=11 роль, L=12 процент. С 19.09 роль без процента чистит L; удаление лота чистит L (раньше % зависал и выглядел как «роль в таблице не та»).
